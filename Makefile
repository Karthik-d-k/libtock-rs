...
usage:
	...
	@echo " - raspberry_pi_pico2_arm"
	@echo " - raspberry_pi_pico2_riscv"
...
$(eval $(call platform_build,raspberry_pi_pico2_arm,thumbv8m.main-none-eabi))
$(eval $(call platform_build,raspberry_pi_pico2_riscv,riscv32imac-unknown-none-elf))
